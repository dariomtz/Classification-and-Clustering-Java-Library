...
import java.util.Vector;
        ...
        public class AlgebraTest {
            ...
            @Test
            public void testSubstractVectorMethod(){
                Vector<Integer> v1 = new Vector<>();
                v1.add(5);
                v1.add(3);
                Vector<Double> v2 = new Vector<>();
                ...
                Assert.assertEquals("Sub should return the substraction of 2 vectors in a new vector",v3,Algebra.substractVector(v1,v2));
            }
            @Test
            ...
            public void testMultEscMethod(){
                ...
                Assert.assertEquals("Should return product of a mult x esc",v5,Algebra.multEsc(0.1,v4));
            }
        }